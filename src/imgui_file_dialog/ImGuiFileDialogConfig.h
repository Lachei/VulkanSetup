...
#define IGFD_KEY_UP SDL_SCANCODE_UP//SDLK_UP//GLFW_KEY_UP
// Down key for explore to the bottom
#define IGFD_KEY_DOWN SDL_SCANCODE_DOWN//SDLK_DOWN//GLFW_KEY_DOWN
...
#define IGFD_EXIT_KEY SDL_SCANCODE_ESCAPE//SDLK_ESCAPE//GLFW_KEY_ESCAPE
